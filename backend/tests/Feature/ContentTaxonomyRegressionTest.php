...
class ContentTaxonomyRegressionTest extends TestCase
{
    ...
    public function test_table_round_trip_tags_and_manual_related_order_are_preserved(): void
    {
        ...
        $payload = [
            ...
            'summary' => 'Tóm tắt', 'content' => $table, 'status' => 'published',
        ...
        $content = Post::findOrFail($postId)->content;
    ...
    public function test_regions_are_normalized_unique_public_only_and_static_route_precedes_slug(): void
    {
        ...
        Project::create(['name' => 'Cũ', 'slug' => 'cu', 'region' => 'Hà Nội', 'is_published' => true]);
        ...
        $this->getJson('/api/v1/projects?region=Mi%E1%BB%81n%20B%E1%BA%AFc')->assertOk()->assertJsonCount(2, 'data');
