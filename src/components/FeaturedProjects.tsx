  ...
  return (
    <section className="py-16 sm:py-20 bg-cream">
      <Container>
        ...
        {error && (
          <ErrorState
            message="Không thể kết nối máy chủ để tải danh mục dự án."
            onRetry={() => refetch()}
          />
        )}
        ...
        {!isLoading && !error && projects.length === 0 && (
          <EmptyState
            title="Chưa có dự án nổi bật nào"
            description="Vui lòng quay lại sau để cập nhật danh mục dự án mới nhất."
          />
        )}
                        ...
                        >
                          <Heart
                            ...
                            className={`transition-colors duration-300 ${
                              isFav ? "text-[#EF4444] fill-[#EF4444]" : "text-muted hover:text-gold"
                            }`}
                          />
                        </button>
