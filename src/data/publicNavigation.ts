...
export const publicFooterColumns: FooterColumn[] = [
  { title: 'MASTERISE HOMES', links: publicNavigation },
  { title: 'DỰ ÁN', links: [
  ...
  { title: 'THÔNG TIN', links: [
    { label: 'Tin tức', href: '/tin-tuc' }, { label: 'Đầu tư', href: '/dau-tu' },
    { label: 'Tuyển dụng', href: '/tuyen-dung' }, { label: 'Chuyên trang', href: '/chuyen-trang' },
